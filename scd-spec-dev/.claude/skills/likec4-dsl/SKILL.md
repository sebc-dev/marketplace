...
---
<!-- Vendorisé depuis github.com/likec4/likec4 › skills/likec4-dsl @ v1.59.3 — licence MIT — copié le 2026-09-12. -->
<!-- Règle de resynchronisation : recopier tel quel, jamais fusionner. Le dossier evals/ de l'original n'est pas repris. -->
<!-- Le plugin scd-spec-dev ne modifie pas ce skill : les conventions propres au plugin sont dans le skill `architecture`. -->
