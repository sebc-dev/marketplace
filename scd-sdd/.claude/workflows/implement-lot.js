export const meta = {
  ...
  whenToUse: "Après une gate analyze au vert de scd-sdd, pour implémenter un lot Rn de specs/NNN-feature/tasks.md.",
  phases: [
...
const brief = await agent(
  ...
  { agentType: 'scd-sdd:lot-briefer', schema: BRIEF, model: 'sonnet' },
)
