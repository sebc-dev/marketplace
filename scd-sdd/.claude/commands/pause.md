...
7. **Affiche la fiche en entier et fais-la valider** (`AskUserQuestion`). C'est le seul garde-fou
   contre une fiche fabriquée. Un refus est définitif : tu n'écris rien.
...
⏸ Chantier posé — « Verrouillage du compte après 5 échecs »
   docs/chantiers/en-cours/2026-08-04-verrou-compte.md · 001-auth · lot R2
   branche impl/auth-R2 · a1b2c3d · commit 4f2e1a0

   Contexte : 2 à lire (118 l.) · 1 à extraire · 1 à déléguer · 2 à situer
