...
- [`brand-voice` — the embedded MCP servers](#brand-voice--the-embedded-mcp-servers)
- [Frontmatters worth having read](#frontmatters-worth-having-read)
- [What was not read](#what-was-not-read)

## Repositories

`Licence` is `license.spdx_id` **declared at repository level**; `—` means none is declared *there*,
not that none exists anywhere.

| Repository | ★ | forks | Licence (repo) | Last push | Created |
|---|---|---|---|---|---|
| `anthropics/skills` | 168 593 | 20 085 | **—** | 2026-08-07 | 2025-09-22 |
...
| `ComposioHQ/awesome-claude-skills` | 72 392 | 8 247 | — | 2026-08-10 | 2025-10-17 |
...
| `Yaroslavle/seo-content-writer-claude-skill` | 27 | 4 | — | 2026-03-28 | 2026-03-28 |
...
Two spellings to get right: the owner is **`AgriciDaniel`** with a lowercase i — GitHub's
...
|---|---|
| `knowledge-work-plugins` is MIT | **Apache-2.0** — SPDX field *and* the body of `LICENSE` |
...
## `brand-voice` — the embedded MCP servers
