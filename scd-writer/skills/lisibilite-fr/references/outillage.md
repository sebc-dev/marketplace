...
- [Grammalecte — the reserves that travel with the fact](#grammalecte--the-reserves-that-travel-with-the-fact)
...
**French rule count: 7 016 at tag v6.8** — 5 336 in `grammar.xml` plus 1 680 in `style.xml`, counted
...
## Grammalecte — the reserves that travel with the fact
...
- **No versioned artefact of 2.3 was located.** The `algoo/grammalecte` repository stops at tag v2.2,
  last push 2025-08-18 — it is not the canonical source of the release. Recommending Grammalecte as
