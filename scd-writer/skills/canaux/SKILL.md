...
| **Short form** | — | LinkedIn post (80–300 words) |
...
| Links | Inline, freely | Never in the body — reach is penalized. First comment, or nowhere |
| Code | Fenced blocks | Screenshot, or don't |
| Entry | A reader who already clicked | A reader who has not decided to read — the first two lines are all you get |
...
1. **The counterintuitive claim.** A statement most of the audience would dispute — that the body then defends. Not a provocation you abandon in line three.
