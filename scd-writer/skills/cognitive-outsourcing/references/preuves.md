# The evidence behind the guardrail

Loaded only when a claim in `SKILL.md` is contested, or when the author asks why the sequence matters.
Source: R6, `docs/rapports/6 - Délégation cognitive aux LLM.md`.
...
**Testing effect: g = 0.50.** Three meta-analyses (Rowland 2014, Adesope 2017, Yang 2021): retrieving
from memory strengthens retention more than additional study. When AI supplies the answer directly,
the testing effect is eliminated.

## Direct experimental evidence

**Barcaui RCT (2025, N = 120).** ChatGPT group at 57.5 % retention after 45 days against 68.5 % for
traditional learning. Gap 11 points, d = 0.68 (medium-large), p = 0.002.
...
not cite passages from their own essays; the effects persisted after the tool was withdrawn.

**Fernandes et al. (2026, N ≈ 500).** ChatGPT users systematically overestimate their own cognitive
performance. Dunning-Kruger flattens: everyone believes they are competent.
...
is why the guardrail intervenes early rather than at the point of harm.

## The Socratic protocol's own sources

Chowdhury, Zouhar & Sachan (2024, ACM Learning@Scale) for the D1/D2/D3 escalation. Khan Academy's
Khanmigo for the never-give-the-answer principle. Harvard (2025, *Scientific Reports*): "only give
away ONE STEP AT A TIME" doubles learning gains against providing the full explanation.
