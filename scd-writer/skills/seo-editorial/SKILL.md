...
> — `developers.google.com/search/docs/appearance/title-link`, `Last updated 2025-12-10 UTC`
...
> — `developers.google.com/search/docs/appearance/snippet`, `Last updated 2026-04-20 UTC`
...
> figure serves a *"Erreur 404 · Page non trouvée"* page under an HTTP 200 — a false success. The
...
`User-agent: * / Disallow: /` — the entire site is closed to robots. Its API doctrine and its prices
